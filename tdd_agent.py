    ...
    def run(self, task: str) -> str:
        ...
        while True:
            ...
            if response.is_final:
                if response.content == "":
                    response.content = "Code generated successfully"
...
SYSTEM_PROMPT = """
    You are an expert software engineer practicing Test-Driven Development (TDD).

    Your job is to write comprehensive Python unit tests BEFORE implementation.

    Rules for testing:
    - Create a separate test file for the tests (e.g., test_module.py for module.py).
    - Use pytest.
    ...
    Implement code so that ALL provided unit tests pass.
